...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String name,  String email,  String phone,  String password,  String address,  String age,  String place,  double latitude,  double longitude,  String gender)?  userRegister,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _UserRegister() when userRegister != null:
return userRegister(_that.name,_that.email,_that.phone,_that.password,_that.address,_that.age,_that.place,_that.latitude,_that.longitude,_that.gender);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String name,  String email,  String phone,  String password,  String address,  String age,  String place,  double latitude,  double longitude,  String gender)  userRegister,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String name,  String email,  String phone,  String password,  String address,  String age,  String place,  double latitude,  double longitude,  String gender)?  userRegister,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _UserRegister() when userRegister != null:
return userRegister(_that.name,_that.email,_that.phone,_that.password,_that.address,_that.age,_that.place,_that.latitude,_that.longitude,_that.gender);case _:
...
class _UserRegister implements RegisterBlocEvent {
  const _UserRegister({required this.name, required this.email, required this.phone, required this.password, required this.address, required this.age, required this.place, required this.latitude, required this.longitude, required this.gender});
...
@override
int get hashCode => Object.hash(runtimeType,name,email,phone,password,address,age,place,latitude,longitude,gender);

@override
String toString() {
  return 'RegisterBlocEvent.userRegister(name: $name, email: $email, phone: $phone, password: $password, address: $address, age: $age, place: $place, latitude: $latitude, longitude: $longitude, gender: $gender)';
}
...
@useResult
$Res call({
 String name, String email, String phone, String password, String address, String age, String place, double latitude, double longitude, String gender
});
...
/// Create a copy of RegisterBlocEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? name = null,Object? email = null,Object? phone = null,Object? password = null,Object? address = null,Object? age = null,Object? place = null,Object? latitude = null,Object? longitude = null,Object? gender = null,}) {
