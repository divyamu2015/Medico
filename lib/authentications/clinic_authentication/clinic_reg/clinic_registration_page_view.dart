...
import 'package:medico_project/authentications/clinic_authentication/clinic_login/clinic_login_view_page.dart';
...
class _ClinicRegistrationPageState extends State<ClinicRegistrationPage>
  ...
  //   try {
  //     final response = await http.get(Uri.parse(Urlsss.getCategoriesUrl));
  ...
  Future<void> saveForm() async {
    ...
    context.read<ClinicRegistrationBloc>().add(
      ClinicRegistrationEvent.clinicRegister(
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocConsumer<ClinicRegistrationBloc, ClinicRegistrationState>(
            ...
            state.when(
              ...
              success: (response) {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) {
                      return const ClinicLoginScreen();
                    },
                  ),
                );
              },
