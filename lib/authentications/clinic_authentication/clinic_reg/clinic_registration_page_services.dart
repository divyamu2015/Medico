...
Future<ClinicRegModel> cliRegister({
  ...
  try {
    final String url = Urlsss.regClinicUrl;
    ...
    request.fields['clinic_phone'] = phone.toString();
    request.fields['clinic_address'] = address;
    ...
    request.fields['role'] = 'clinic_doctor';
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      print(decoded);
      return ClinicRegModel.fromJson(decoded);
    } else {
