...
import 'package:medico_project/authentications/clinic_authentication/clinic_reg/clinic_registration_page_view.dart';
import 'package:medico_project/screens/clinic_doctor_screens/clinic_home_screen/clinic_home_screen.dart';
...
class _ClinicLoginScreenState extends State<ClinicLoginScreen>
  ...
  final String _selectedUserType = 'clinic_doctor';
  int? clinicDoctorId;
  ...
  void initState() {
    ...
    print('Hello from Clinic Login Screen');
  }
  ...
  Future<void> storeClinicId(int doctorId) async {
  ...
  Future<int?> getClinicId() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    clinicDoctorId = prefs.getInt('id');
    print("Retrieved User ID: $clinicDoctorId");
          ...
          listener: (context, state) {
            state.when(
              ...
              success: (response) async {
                await storeClinicId(response.clinicdocId);
                //  await storeClinicId(response.);
                clinicDoctorId = await getClinicId();
                setState(() {
                  isloading = false;
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text("Clinic Doctor login successful"),
                  ...
                  Navigator.of(context).pushReplacement(
                    MaterialPageRoute(
                      builder: (context) {
                        return ClinicDocHomeScreen(doctorId: clinicDoctorId!,);
                        // ChatScreen(userId: userId!);
                       // BookAppointmentScreen(clinicDoctorId: clinicDoctorId!,);
                      },
                    ),
                  );
                });
