...
class _HospitalBookAppointmentScreenState
  ...
  Future<void> postAvailability(bool available) async {
    final url = Uri.parse(
      "https://417sptdw-8002.inc1.devtunnels.ms/userapp/hospital-doctor/$clinicDoctorId/availability/",
    );
  //  print(url);
  ...
  Future<void> getDoctorDetails() async {
    final url = Uri.parse(
      'https://417sptdw-8002.inc1.devtunnels.ms/userapp/view_hospital_doctor/$clinicDoctorId/',
    );
    print(url);
