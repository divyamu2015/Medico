...
class FindDoctorScreen extends StatefulWidget {
  const FindDoctorScreen({super.key, required this.userId});
  final int userId;
...
class _FindDoctorScreenState extends State<FindDoctorScreen> {
  ...
  Future<void> fetchClinicDoc() async {
    context.read<ListNearbyclincDocBloc>().add(
      ListNearbyclincDocEvent.listclinicDoc(userId: userId!),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<ListNearbyclincDocBloc, ListNearbyclincDocState>(
...
class DoctorCard extends StatelessWidget {
  final NearbyClinicDoctor doctor;
