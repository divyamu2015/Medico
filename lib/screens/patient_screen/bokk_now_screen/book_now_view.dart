...
import 'package:medico_project/screens/patient_screen/feedback_page.dart';
...
class _BookNowScreenState extends State<BookNowScreen> {
  ...
  void initState() {
    ...
    context.read<BookNowBloc>().add(
      BookNowEvent.bookNow(doctorId: widget.doctorId),
    );
  ...
  Future<void> fetchDoctorTimeSlots() async {
    try {
      ...
      final url = Uri.parse(
        'https://417sptdw-8002.inc1.devtunnels.ms/userapp/clinic/doctor/${widget.doctorId}/timeslots/',
      );
  ...
  Future<void> bookSlot() async {
    ...
    final url = Uri.parse(Urlsss.clinicBookSlot);
    ...
    if (response.statusCode == 201) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) {
            return FeedbackPage(userid: userId, doctorId: doctorId);
          },
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<BookNowBloc, BookNowState>(
