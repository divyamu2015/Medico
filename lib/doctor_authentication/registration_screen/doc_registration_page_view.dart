...
import 'package:medico_project/doctor_authentication/registration_screen/bloc/register_bloc_bloc.dart'; // Import for HTTP requests
...
class _DoctorRegistrationPageState extends State<DoctorRegistrationPage>
  ...
  Widget _buildCategorySelector() {
    ...
    //   // You can show a loading, error, or empty state here
      ...
      child: DropdownButton<String>(
        ...
        onChanged: (value) {
          setState(() {
            ...
            // Do other logic if needed on selection
          });
        },
      ),
    );
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      const SizedBox(height: 10),
                                      _buildCategorySelector(), // Reduced spacing
                                      const SizedBox(height: 10),
                                      _buildTextField(
                                        "Specialization",
