...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String name,  String email,  String phone,  String password,  String address,  String age,  String place,  double latitude,  double longitude,  String gender,  String category,  String experience,  String specialzation,  XFile profilePic,  XFile medicalCertificate)?  docuserRegister,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _DocUserRegister() when docuserRegister != null:
return docuserRegister(_that.name,_that.email,_that.phone,_that.password,_that.address,_that.age,_that.place,_that.latitude,_that.longitude,_that.gender,_that.category,_that.experience,_that.specialzation,_that.profilePic,_that.medicalCertificate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String name,  String email,  String phone,  String password,  String address,  String age,  String place,  double latitude,  double longitude,  String gender,  String category,  String experience,  String specialzation,  XFile profilePic,  XFile medicalCertificate)  docuserRegister,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String name,  String email,  String phone,  String password,  String address,  String age,  String place,  double latitude,  double longitude,  String gender,  String category,  String experience,  String specialzation,  XFile profilePic,  XFile medicalCertificate)?  docuserRegister,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _DocUserRegister() when docuserRegister != null:
return docuserRegister(_that.name,_that.email,_that.phone,_that.password,_that.address,_that.age,_that.place,_that.latitude,_that.longitude,_that.gender,_that.category,_that.experience,_that.specialzation,_that.profilePic,_that.medicalCertificate);case _:
...
class _DocUserRegister implements DocRegisterBlocEvent {
  const _DocUserRegister({required this.name, required this.email, required this.phone, required this.password, required this.address, required this.age, required this.place, required this.latitude, required this.longitude, required this.gender, required this.category, required this.experience, required this.specialzation, required this.profilePic, required this.medicalCertificate});
...
@override
int get hashCode => Object.hash(runtimeType,name,email,phone,password,address,age,place,latitude,longitude,gender,category,experience,specialzation,profilePic,medicalCertificate);

@override
String toString() {
  return 'DocRegisterBlocEvent.docuserRegister(name: $name, email: $email, phone: $phone, password: $password, address: $address, age: $age, place: $place, latitude: $latitude, longitude: $longitude, gender: $gender, category: $category, experience: $experience, specialzation: $specialzation, profilePic: $profilePic, medicalCertificate: $medicalCertificate)';
}
...
@useResult
$Res call({
 String name, String email, String phone, String password, String address, String age, String place, double latitude, double longitude, String gender, String category, String experience, String specialzation, XFile profilePic, XFile medicalCertificate
});
...
/// Create a copy of DocRegisterBlocEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? name = null,Object? email = null,Object? phone = null,Object? password = null,Object? address = null,Object? age = null,Object? place = null,Object? latitude = null,Object? longitude = null,Object? gender = null,Object? category = null,Object? experience = null,Object? specialzation = null,Object? profilePic = null,Object? medicalCertificate = null,}) {
