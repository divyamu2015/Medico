...
class _UserLogin implements DocLoginEvent {
...
@override
String toString() {
  return 'DocLoginEvent.userLogin(role: $role, password: $password, email: $email)';
}
...
/// @nodoc
abstract mixin class _$UserLoginCopyWith<$Res> implements $DocLoginEventCopyWith<$Res> {
